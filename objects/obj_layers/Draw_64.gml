...
for ( var l = 0; l < 8; l ++ )
{
	...
	if !is_undefined(cache[? chunk_get_key()]) && !is_undefined(cache[? chunk_get_key()][l])
		draw_sprite_stretched(cache[? chunk_get_key()][l], 0, bbox_left + pad, bbox_top + pad + hh * l, ww, hh - pad);
}
